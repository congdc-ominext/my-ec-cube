...
class EccubeEccube_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Plugin\\SiteKit\\Controller\\Admin\\ConfigController' => 'getConfigControllerService.php',
            'Plugin\\SiteKit\\Controller\\Admin\\DashboardController' => 'getDashboardControllerService.php',
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/app/Plugin/SiteKit/Resource/template'), 'SiteKit');
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->privates['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.3duxsb8'] ?? ($this->privates['.security.request_matcher.3duxsb8'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
