...
// Returns the public 'Plugin\SiteKit\Controller\Admin\DashboardController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'SiteKit'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'DashboardController.php';

$this->services['Plugin\\SiteKit\\Controller\\Admin\\DashboardController'] = $instance = new \Plugin\SiteKit\Controller\Admin\DashboardController(($this->privates['Plugin\\SiteKit\\Service\\Google_Site_Kit_Proxy_Client'] ?? $this->load('getGoogleSiteKitProxyClientService.php')));
