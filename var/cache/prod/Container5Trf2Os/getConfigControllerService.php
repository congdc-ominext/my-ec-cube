...
// Returns the public 'Plugin\SiteKit\Controller\Admin\ConfigController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'Plugin'.\DIRECTORY_SEPARATOR.'SiteKit'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'ConfigController.php';

$this->services['Plugin\\SiteKit\\Controller\\Admin\\ConfigController'] = $instance = new \Plugin\SiteKit\Controller\Admin\ConfigController(($this->privates['Eccube\\Repository\\BaseInfoRepository'] ?? $this->getBaseInfoRepositoryService()), ($this->privates['Plugin\\SiteKit\\Repository\\IdTokenRepository'] ?? $this->load('getIdTokenRepositoryService.php')), ($this->privates['Plugin\\SiteKit\\Service\\Google_Site_Kit_Proxy_Client'] ?? $this->load('getGoogleSiteKitProxyClientService.php')));
