...
// Returns the public 'Eccube\Controller\ContactController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Eccube'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ContactController.php';

$this->services['Eccube\\Controller\\ContactController'] = $instance = new \Eccube\Controller\ContactController(($this->privates['Eccube\\Service\\MailService'] ?? $this->load('getMailServiceService.php')), ($this->privates['Eccube\\Repository\\PageRepository'] ?? $this->load('getPageRepositoryService.php')));
