...
// Returns the public 'Eccube\Controller\Admin\Store\TemplateController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Eccube'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'Store'.\DIRECTORY_SEPARATOR.'TemplateController.php';

$this->services['Eccube\\Controller\\Admin\\Store\\TemplateController'] = $instance = new \Eccube\Controller\Admin\Store\TemplateController(($this->privates['Eccube\\Repository\\TemplateRepository'] ?? $this->load('getTemplateRepositoryService.php')), ($this->privates['Eccube\\Repository\\Master\\DeviceTypeRepository'] ?? $this->load('getDeviceTypeRepositoryService.php')));
