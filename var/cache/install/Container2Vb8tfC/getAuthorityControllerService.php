...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Eccube'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'Setting'.\DIRECTORY_SEPARATOR.'System'.\DIRECTORY_SEPARATOR.'AuthorityController.php';

$this->services['Eccube\\Controller\\Admin\\Setting\\System\\AuthorityController'] = $instance = new \Eccube\Controller\Admin\Setting\System\AuthorityController(($this->privates['Eccube\\Repository\\AuthorityRoleRepository'] ?? $this->load('getAuthorityRoleRepositoryService.php')));
