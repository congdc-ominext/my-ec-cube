...
return new \Eccube\Log\Logger(($this->privates['Eccube\\Request\\Context'] ?? $this->load('getContextService.php')), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['monolog.logger.front'] ?? $this->load('getMonolog_Logger_FrontService.php')), ($this->services['monolog.logger.admin'] ?? $this->load('getMonolog_Logger_AdminService.php')));
