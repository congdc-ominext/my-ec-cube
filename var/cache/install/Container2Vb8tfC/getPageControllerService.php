...
// Returns the public 'Eccube\Controller\Admin\Content\PageController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Eccube'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'Content'.\DIRECTORY_SEPARATOR.'PageController.php';

$this->services['Eccube\\Controller\\Admin\\Content\\PageController'] = $instance = new \Eccube\Controller\Admin\Content\PageController(($this->privates['Eccube\\Repository\\PageRepository'] ?? $this->load('getPageRepositoryService.php')), ($this->privates['Eccube\\Repository\\PageLayoutRepository'] ?? $this->load('getPageLayoutRepositoryService.php')), ($this->privates['Eccube\\Repository\\Master\\DeviceTypeRepository'] ?? $this->load('getDeviceTypeRepositoryService.php')));
