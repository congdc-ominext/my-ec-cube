...
// Returns the public 'Eccube\Controller\Install\InstallController' shared autowired service.
...
$this->services['Eccube\\Controller\\Install\\InstallController'] = $instance = new \Eccube\Controller\Install\InstallController(($this->privates['Eccube\\Security\\Core\\Encoder\\PasswordEncoder'] ?? $this->load('getPasswordEncoderService.php')), ($this->privates['Eccube\\Util\\CacheUtil'] ?? ($this->privates['Eccube\\Util\\CacheUtil'] = new \Eccube\Util\CacheUtil(($this->services['kernel'] ?? $this->get('kernel', 1)), $this))));
