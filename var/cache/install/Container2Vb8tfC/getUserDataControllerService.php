...
// Returns the public 'Eccube\Controller\UserDataController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Eccube'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'UserDataController.php';

$this->services['Eccube\\Controller\\UserDataController'] = $instance = new \Eccube\Controller\UserDataController(($this->privates['Eccube\\Repository\\PageRepository'] ?? $this->load('getPageRepositoryService.php')), ($this->privates['Eccube\\Repository\\Master\\DeviceTypeRepository'] ?? $this->load('getDeviceTypeRepositoryService.php')));
