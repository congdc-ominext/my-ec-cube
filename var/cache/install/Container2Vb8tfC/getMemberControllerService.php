...
// Returns the public 'Eccube\Controller\Admin\Setting\System\MemberController' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Eccube'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'Setting'.\DIRECTORY_SEPARATOR.'System'.\DIRECTORY_SEPARATOR.'MemberController.php';

$this->services['Eccube\\Controller\\Admin\\Setting\\System\\MemberController'] = $instance = new \Eccube\Controller\Admin\Setting\System\MemberController(($this->privates['security.encoder_factory.generic'] ?? $this->load('getSecurity_EncoderFactory_GenericService.php')), ($this->privates['Eccube\\Repository\\MemberRepository'] ?? $this->load('getMemberRepositoryService.php')), ($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()));
